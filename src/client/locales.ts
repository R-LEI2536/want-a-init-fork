 ...
 * description, expand/collapse hint), the field label and hint, the
 * dropdown options, and the save/discard buttons. zh + en shipped;
 * extend by adding the same key to both `en` and `zh`.
 */
