...
export const WANT_A_INIT_SETTINGS_NAMESPACE = settingsNamespace('want-a-init')
...
export function apply(ctx, config) {
  // Cordis config supplies the deployment-level default; installSettingsSection
  // may overwrite this through the user-settings layer (WebUI hot-reload).
  ...
  installSettingsSection(ctx, WANT_A_INIT_SETTINGS_NAMESPACE, Config, config, {
    setSource: (current) => {
